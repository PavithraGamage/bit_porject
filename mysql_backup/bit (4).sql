...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2022 at 08:51 PM
...
INSERT INTO `billing_details` (`id`, `first_name`, `last_name`, `phone`, `email`, `address_line_1`, `address_line_2`, `city`, `zip`, `province_id`, `user_id`, `order_id`) VALUES
(1, 'f_name', 'L-name', 1234567890, 'tets@tsest', 'Addr_1', 'Addr_2', 'city', 0, 'privince', '1250', 0),
(2, 'dawd', 'dawd', 23422, 'das@sa.kl', 'dasdaw', 'dawdad', 'dawada', 0, 'South', '231312', 0),
(3, 'jhjsah', 'jhjsh', 8309280, 'jskj@kjsa.lk', 'kkasolkj', 'kjsi', 'jjoisjoi', 0, 'Western', '8329', 0),
(4, 'dasd', 'dadaw', 123121, 'das@sa.lk', 'kjkliao', 'oioioi', 'osoio', 0, 'South', '2390', 0),
(5, 'dasda', 'dadaw', 123123, 'das@sa.lk', 'khsakjh', 'hkjhskh', 'khjkhskh', 0, 'Western', '218', 0),
(6, 'nishan', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', 0, '- Select -', '12530', 0),
(7, 'nishan', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', 0, '- Select -', '12530', 0),
(8, 'nishan', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', 0, '4', '12530', 0),
(9, 'Namal', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', 0, '2', '12530', 0);
...
INSERT INTO `delivery_details` (`id`, `frist_name`, `last_name`, `phone`, `email`, `address_line_1`, `address_line_2`, `city`, `province_id`, `zip`) VALUES
(1, 'dasda', 'dadaw', 123123, 'das@sa.lk', 'khsakjh', 'hkjhskh', 'khjkhskh', 'Western', 218),
(2, 'nishan', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', '- Select -', 12530),
(3, 'nishan', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', '- Select -', 12530),
(4, 'nishan', 'Amarabandu', 757003662, 'nishan@ustar.com', 'address line 1', 'address line 2', 'bandaragama', 'Select', 12530);
...
('0102', 'Add Status', 'troubleshooting/faq', 'add_status', '', 1),
...
('11', 'Appointments', 'appointments/customers', '', 'insert', 1),
('1101', 'View Appointments', 'appointments/customers', 'view', '', 1),
('12', 'Job Management', 'jobs/customers', '', 'jobs', 1),
('1201', 'View Taken Jobs', 'jobs/customers', 'view_jobs', '', 1);
