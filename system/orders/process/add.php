                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <table id="brand_list" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                 ...
                                 if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$action == 'search') {
                                     ...
                                     if (!empty($cus_search)) {
                                         ...
                                         $where .= "CONCAT(o.order_id, o.order_number, o.order_date, o.order_time, u.first_name, u.last_name, cs.courier_status) LIKE '%$cus_search%' AND ";
                                     }
                                     // dynamic query
                              ...
                              $where
                              AND o.courier_status IN (3,5,6) ORDER BY o.order_number DESC";
