    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Insert New Manufacturer</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Manufacturer Name" name="man_name">
                            </div>
                        </div>
                        <!-- /.card-body -->
            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Available Manufacturers</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
