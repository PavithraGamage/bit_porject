...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Revenue Summary Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        ...
                        <table id="item_list" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                // sql query
                                $sql = "SELECT SUM(oi.item_qty) AS item_qty, SUM(oi.grn_price) AS grn_price, SUM(oi.unit_price) AS unit_price, SUM(oi.net_price) AS net_price, o.order_date
